...
namespace ConexionBD.DataSet {
    ...
    public partial class MyDataSet : global::System.Data.DataSet {
        ...
        public partial class usuarioDataTable : global::System.Data.TypedTableBase<usuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuarioRow AddusuarioRow(int idusuario, string nombre, string apellido, int edad, System.DateTime fecha_nacimiento) {
...
namespace ConexionBD.DataSet.MyDataSetTableAdapters {
    ...
    public partial class usuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [usuario] WHERE (([idusuario] = @Original_idusuario) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ((@IsNull_edad = 1 AND [edad] IS NULL) OR ([edad] = @Original_edad)) AND ((@IsNull_fecha_nacimiento = 1 AND [fecha_nacimiento] IS NULL) OR ([fecha_nacimiento] = @Original_fecha_nacimiento)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [usuario] ([idusuario], [nombre], [apellido], [edad], [fecha_nacimiento]) VALUES (@idusuario, @nombre, @apellido, @edad, @fecha_nacimiento);
SELECT idusuario, nombre, apellido, edad, fecha_nacimiento FROM usuario WHERE (idusuario = @idusuario)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [usuario] SET [idusuario] = @idusuario, [nombre] = @nombre, [apellido] = @apellido, [edad] = @edad, [fecha_nacimiento] = @fecha_nacimiento WHERE (([idusuario] = @Original_idusuario) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ((@IsNull_edad = 1 AND [edad] IS NULL) OR ([edad] = @Original_edad)) AND ((@IsNull_fecha_nacimiento = 1 AND [fecha_nacimiento] IS NULL) OR ([fecha_nacimiento] = @Original_fecha_nacimiento)));
SELECT idusuario, nombre, apellido, edad, fecha_nacimiento FROM usuario WHERE (idusuario = @idusuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ConexionBD.Properties.Settings.Default.info_dbConnectionString;
        }
        ...
        public virtual MyDataSet.usuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDataSet.usuarioDataTable dataTable = new MyDataSet.usuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDataSet.usuarioDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idusuario, string Original_nombre, string Original_apellido, global::System.Nullable<int> Original_edad, global::System.Nullable<global::System.DateTime> Original_fecha_nacimiento) {
        ...
        public virtual int Insert(int idusuario, string nombre, string apellido, global::System.Nullable<int> edad, global::System.Nullable<global::System.DateTime> fecha_nacimiento) {
        ...
        public virtual int Update(int idusuario, string nombre, string apellido, global::System.Nullable<int> edad, global::System.Nullable<global::System.DateTime> fecha_nacimiento, int Original_idusuario, string Original_nombre, string Original_apellido, global::System.Nullable<int> Original_edad, global::System.Nullable<global::System.DateTime> Original_fecha_nacimiento) {
        ...
        public virtual int Update(string nombre, string apellido, global::System.Nullable<int> edad, global::System.Nullable<global::System.DateTime> fecha_nacimiento, int Original_idusuario, string Original_nombre, string Original_apellido, global::System.Nullable<int> Original_edad, global::System.Nullable<global::System.DateTime> Original_fecha_nacimiento) {
            return this.Update(Original_idusuario, nombre, apellido, edad, fecha_nacimiento, Original_idusuario, Original_nombre, Original_apellido, Original_edad, Original_fecha_nacimiento);
        }
    }
